...
# 8080: http
# 8181: https
EXPOSE 4848 9009 8080 8181 4900 5900 6900 5700 5701 4901 5901 6901
...
RUN wget --no-verbose -O payara.zip ${PAYARA_PKG} && \
    ...
    ${PAYARA_DIR}/bin/asadmin --user=${ADMIN_USER} --passwordfile=${PASSWORD_FILE} set-hazelcast-configuration --clustermode kubernetes --startport 4900 && \
